...
create-react-app start-react-with-redux-observable
cd start-react-with-redux-observable
```

### Install React-Router & Redux & Redux-Observable

```sh
npm i --save react-router redux react-redux react-router-redux rxjs redux-observable
```
